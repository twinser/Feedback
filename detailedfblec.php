...
<?php
//if an answer was empty, show the empty paragraph
...
<br>
<p> <a class="btn btn-warning" href="selectfbtypelec.php" role="button">Go back to the menu without submitting</a>  &nbsp; &nbsp; &nbsp;  <a class="btn btn-danger" href="Logout.php" role="button">Cancel feedback</a> </p>
</div>
